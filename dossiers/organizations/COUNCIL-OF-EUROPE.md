...
## Identity scope
Canonical identity `ORG-COUNCIL-OF-EUROPE`; ABox metadata remains authoritative.

## State governance context
`MDA` context is `S` only; no entity-level governance inheritance.
...
## Visual evidence
![State context](../assets/generated/ORG-COUNCIL-OF-EUROPE-status.svg)
![Evidence boundary](../assets/generated/ORG-COUNCIL-OF-EUROPE-evidence.svg)
